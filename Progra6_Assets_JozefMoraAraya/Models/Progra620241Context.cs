...
public partial class Progra620241Context : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.AssetId).HasName("PK__Asset__43492372A1C16F5D");
        ...
        {
            entity.HasKey(e => e.AssetCategoryId).HasName("PK__AssetCat__C381F49D8EBAB0AC");
        ...
        {
            entity.HasKey(e => e.DepartmentId).HasName("PK__Departme__B2079BCD979F6DD1");
        ...
        {
            entity.HasKey(e => e.DepreciationId).HasName("PK__Deprecia__DEEBFE29B89F2FA4");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CCAC253F5515");
        ...
        {
            entity.HasKey(e => e.UserRoleId).HasName("PK__UserRole__3D978A5500EAF28C");
